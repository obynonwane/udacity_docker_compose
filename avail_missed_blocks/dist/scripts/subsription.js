...
var Subscription = /** @class */ (function () {
    ...
    Subscription.prototype.main = function () {
        return __awaiter(this, void 0, void 0, function () {
            var wsProvider, api, validator, validatorcount, chain, lastHeader, block, hash, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        // Wait until we are ready and connected
                        _a.sent();
                        return [4 /*yield*/, api.query.staking.validatorCount()];
                    case 3:
                        validator = _a.sent();
                        validatorcount = validator.toNumber();
                    ...
                    case 7:
                        _a.sent();
                        wsProvider.on("disconnected", function () {
                            return console.log("provider", "disconnected");
                        });
                        return [3 /*break*/, 9];
                    case 8:
                        error_1 = _a.sent();
    ...
    Subscription.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var block, hash, validatorcount, conn, lastRecord, totalMissedBlock, tblock, sql, result, newBlock, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        console.log("--------------------------------------------");
                        console.log("\n");
                        block = data.block, hash = data.hash, validatorcount = data.validatorcount;
                    ...
                    case 2:
                        ...
                        sql = "INSERT INTO blocks (blocknumber, validatorcount, hash, missedblocks, block_produced_within_time) VALUES($1, $2, $3, $4, $5) RETURNING *";
